...
SECRET_KEY = 'django-insecure-hbvls!^x9wb7h7xg0w_+&hpeeozn(m#%s^v)83wldfx*k-v=yv'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', #lo que se agrego #Libreria
...
#Configuración de la carpeta para subir archivos dinamicos
MEDIA_URL = 'media/'
